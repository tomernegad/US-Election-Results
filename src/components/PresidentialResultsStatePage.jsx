...
import "./PresidentialResultsStatePage.css";

export default function PresidentialResultsStatePage() {
  ...
  return (
    <div className="results-container">
      <h1>Presidential Results for {stateName}</h1>
      ...
      <Link to="/PresidentialResults" className="back-to-map-button">
        Back to Map
      </Link>
    </div>
  );
